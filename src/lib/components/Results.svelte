<script lang="ts">
	...
	import type { Transaction } from '../splitter';
	...
	// TODO : automatically evaluate if number of people isn't big
	// Or make records empty
	// FIXME : Position of cards don't change after deleting some of cards
</script>
