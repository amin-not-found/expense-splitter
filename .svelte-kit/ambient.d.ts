...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_package_dependencies_big_js: string;
		npm_package_dependencies_idb: string;
		npm_package_dependencies_just_clone: string;
		...
		npm_package_devDependencies__types_big_js: string;
		...
		npm_package_scripts_precommit: string;
